...
- (void) setup {
    ...
    self.cornerRadius = [NSNumber numberWithInt:6];
}
...
- (void)drawRect:(CGRect)rect
{
    ...
    UIBezierPath* roundedRectanglePath = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(0.5, 0.5, rect.size.width-1.0, rect.size.height-1.0) cornerRadius: [self.cornerRadius intValue]];
